...
{
    public class ODataControllerNoPutWithId64<T> : ODataController where T : class, IId64
    {
        protected readonly ILogger log;
        protected readonly SampleDBContext ctx;

        public ODataControllerNoPutWithId64(IServiceProvider provider, ILogger logger)
        {
            log = logger;
