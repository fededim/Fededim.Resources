...
VERSION HISTORY:
  ...
  20250208	fededim		bugfixes:
							...
							- string truncation due to implicit conversion: CAST('' as NVARCHAR(MAX)) has to added at the beginning of a string concatenation in order to force the string to be actually treated as nvarchar(max) avoiding any kind of truncation(see https://bertwagner.com/posts/why-is-my-varcharmax-variable-getting-truncated/)
